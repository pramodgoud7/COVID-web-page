          ...
          <div className="flex flex-col md:gap-10 gap-16 items-center justify-start w-full">
            ...
            <div className="flex flex-col items-start justify-start max-w-[1146px] mx-auto md:px-5 w-full">
              <div className="flex sm:flex-col flex-row md:gap-10 items-start justify-between w-full">
                <div className="flex sm:flex-1 flex-col gap-3.5 items-start justify-start w-[28%] sm:w-full">
                  <Button
                    className="cursor-pointer font-hkgrotesk font-semibold h-16 rounded-[32px] md:text-3xl sm:text-[28px] text-[32px] text-center w-[312px]"
                    color="light_blue_700_28"
                  >
                    Andhra Pradesh
                  </Button>
                  <Text
              ...
              <Text
                className="mt-[71px] md:text-3xl sm:text-[28px] text-[32px] text-red-A400"
                ...
                <div className="absolute flex flex-col h-full inset-[0] items-center justify-center m-auto w-full">
                  <div className="flex flex-col gap-[11px] items-center justify-start w-full">
                    <div className="flex md:flex-col flex-row md:gap-12 items-end justify-between w-full">
                      <div className="flex md:flex-1 flex-col gap-2 items-center justify-start md:mt-0 mt-11 w-4/5 md:w-full">
              ...
              <div className="bg-gray-900_03 flex flex-col items-center justify-start mt-[50px] pb-[23px] sm:px-5 px-[23px] rounded-[12px] w-full">
              ...
              <List
                className="flex flex-col gap-8 items-center mt-8 w-full"
