      ...
      <div className="bg-gray-900 flex flex-col font-roboto items-center justify-start mx-auto pb-24 w-full">
        <div className="flex flex-col md:gap-10 gap-[68px] items-center justify-start w-full">
          ...
          <div className="flex flex-col items-start justify-start max-w-[1148px] mx-auto md:px-5 w-full">
            ...
            <div className="bg-gray-900_03 flex flex-col items-center justify-end mt-[57px] p-[23px] sm:px-5 rounded-[12px] w-full">
              <div className="flex md:flex-col flex-row gap-2 items-center justify-start mt-2.5 w-[97%] md:w-full">
                ...
                <div className="flex flex-col gap-1.5 items-center justify-start w-[98%] md:w-full">
                  <div className="md:h-[238px] h-[246px] relative w-full">
                    ...
                    <div
                      className="absolute bg-cover bg-no-repeat flex flex-col h-max inset-[0] items-center justify-center m-auto p-[11px] w-[98%]"
                      style={{
                        backgroundImage: "url('images/img_group632.svg')",
                      }}
                    >
                      <Img
                        className="h-[163px] mt-[53px]"
            ...
            <div className="bg-gray-900_05 flex flex-col items-center justify-start mt-12 p-8 sm:px-5 rounded-[12px] w-full">
