...
import VaccineDropdownMenu3 from "components/VaccineDropdownMenu3";

const VaccinedropdownPage = () => {
  return (
    <>
      <div className="bg-gray-900 flex flex-col font-roboto items-center justify-start mx-auto pb-24 w-full">
        <div className="flex flex-col md:gap-10 gap-[68px] items-center justify-start w-full">
          ...
          <div className="flex flex-col items-start justify-start max-w-[1148px] mx-auto md:px-5 w-full">
            ...
            <List
              className="sm:flex-col flex-row gap-4 grid sm:grid-cols-1 grid-cols-2 md:ml-[0] ml-[602px] mt-[37px] w-[48%]"
            ...
            <div className="md:h-[1667px] sm:h-[880px] h-[900px] mt-1 relative w-full">
              <div className="absolute flex flex-col gap-12 h-max inset-[0] items-center justify-center m-auto w-full">
                <List
                  className="sm:flex-col flex-row gap-[30px] grid md:grid-cols-1 grid-cols-2 justify-center w-full"
                  orientation="horizontal"
                >
                  <div className="bg-blue_gray-900_05 flex flex-1 flex-col items-start justify-start sm:ml-[0] p-8 sm:px-5 rounded-[12px] shadow-bs2 w-full">
                  ...
                  <div className="bg-blue_gray-900_05 flex flex-1 flex-col items-start justify-start sm:ml-[0] p-8 sm:px-5 rounded-[12px] shadow-bs2 w-full">
                    <div className="flex flex-col gap-[26px] justify-start w-[52%] md:w-full">
                      <div className="flex flex-row gap-3 items-center justify-between w-full">
                        <Img
                      ...
                      <div className="flex flex-col gap-2.5 items-start justify-start md:ml-[0] ml-[59px] w-[69%] md:w-full">
                        <div className="flex flex-row gap-14 items-center justify-start w-[88%] md:w-full">
                          <Text
                            className="text-base text-blue_gray-100"
                            size="txtRobotoRegular16Bluegray100"
                          >
                ...
                <div className="md:h-[1205px] sm:h-[638px] h-[640px] relative w-full">
                  <div className="flex flex-col h-full items-start justify-start ml-auto mr-[46px] mt-[226px] w-[1%]">
                    <div className="bg-purple-500 h-2 rounded-[50%] w-2"></div>
                    <div className="bg-yellow-400_01 h-2 mt-11 rounded-[50%] w-2"></div>
                    <div className="bg-green-600_01 h-2 ml-0.5 md:ml-[0] mt-[59px] rounded-[50%] w-2"></div>
                  </div>
                  <div className="absolute bg-gray-900_05 flex flex-col h-full inset-[0] items-center justify-center m-auto p-8 sm:px-5 rounded-[12px] w-full">
                      ...
                      <div className="flex md:flex-col flex-row gap-2 items-center justify-between w-full">
                        ...
                        <div className="flex md:flex-1 flex-col gap-[9px] justify-start w-[97%] md:w-full">
                          <div className="h-[446px] relative w-full">
                            ...
                            <Img
                              className="absolute bottom-[4%] h-[271px] inset-x-[0] mx-auto"
              ...
              <VaccineDropdownMenu3 className="absolute flex flex-col items-center justify-start right-[0] top-[0] w-[23%]" />
              <VaccineDropdownMenu3 className="absolute flex flex-col items-center justify-start right-[24%] top-[0] w-[23%]" />
            </div>
            <div className="flex flex-col mt-12 relative w-full">
...
export default VaccinedropdownPage;
